...
export const Modal: FC<PropsWithChildren<ModalPropTypes>> = ({
	title,
	titleContent,
	subTitle,
	icon,
	...
	return (
		...
		>
			...
			{isOpen && (
				<div
					className={`flex gap-4 flex-col shadow-lg rounded-md p-4 top-8 md:top-1/2 left-1/2 z-[120] absolute md:w-[35rem] w-[calc(100vw_-_3rem)] max-h-[calc(100vh_-_5rem)] -translate-x-1/2 md:-translate-y-1/2 bg-slate-700 ${
						modalClassName ?? ""
					}`}
				>
							...
							text={
								isMobile ? (
									...
									<div className="flex items-center gap-2">
										<span>Close</span>
										<span className="py-0.5 px-1 text-xs rounded border uppercase">esc</span>
									</div>
								)
							}
						/>
